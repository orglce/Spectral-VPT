...
float get_transmission_spectrum_value(float wavelength) {
    return 1.0 - get_gaussian_value(wavelength, 1.0, 650.0, 20.0);
}
...
vec3 wavelength_to_RGB(float wavelength) {
    ...
    float z;
    if (wavelength < 557.0) {
        y = get_gaussian_value(x, 151.0 / 268.0, 554.0, 39.0);
    } else {
        y = get_gaussian_value(x, 151.0 / 268.0, 557.0, 43.0);
    }
    if (wavelength < 445.0) {
        z = get_gaussian_value(x, 268.0 / 268.0, 445.0, 18.0);
    } else {
        z = get_gaussian_value(x, 268.0 / 268.0, 447.0, 28.0);
    }
